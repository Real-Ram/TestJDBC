...
public class FlyClass {
	...
	public String[] exp_details() {
		...
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("ramsangl@cisco.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("aaaaaaa");
		driver.findElement(By.xpath("//button")).click();
		driver.findElement(By.linkText("Logout")).click();
		
		
		String exp_email="ramsangl@cisco.com";
		String exp_pwd ="aaaaaaa";
		String exp_name = "ram sangle";
		String exp_adress ="121 Ashoka Nagar";
		String exp_city ="Nanded";
